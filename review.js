...
*/
// const str = "the index of cow"

// // console.log(str.indexOf('cow'))

// const index = str.indexOf('cow')
...
// console.log(`Here is my interpolation using my first name ${secondVar}`)
// ================ Variable Names =================
/* 
...
//let fName="im doing";
//let lName=" alot of homeWork :)"
//console.log(fName+lName)
//****************/

// Create a string and make it return true using startsWith()
//let stri = 'COME ON TEO';
//console.log(stri.startsWith('C'));

//**************/
// Now use any variable with endsWith() and return false
//let randomStr = 'You Kidding my Josh';
//console.log(randomStr.endsWith('M'));
...
//for( let i = 1 ; i <= 10 ; i++) 
 //{
//console.log('my head is spinning ')
//}
...
// for (let j = 1 ; j<= 20; j++){
//   console.log(`Teo is vision has spun ${j} times`);
// }
...
// const newArray = RafaelNoBadWords.split(' ');
// let newFilteredArray=newArray.filter((string1)=>{
// return( string1 !== 'badword')})
// //console.log(newFilteredArray);
// newFilteredArray=newFilteredArray.toString()
// console.log(newFilteredArray.replaceAll(",",' '));
...
//                  else 
//                      {
//                       console.log('He doesnt need to eat')
//                      }      
//           }
//           else 
...
//const Gustavo = 'is the coolest';
//(Gustavo === 'is the coolest')? console.log('you got that right!'):console.log('James wants to argue.He says he is the best')
...
//let printString = function (string9){
//console.log(`this is my ${string9}`)
//}
//printString(amira)
...
// if (name === 'Liv') return('3rd rule: If someone yells "Stop!", goes limp, taps out, the fight is over.') 
// else 
